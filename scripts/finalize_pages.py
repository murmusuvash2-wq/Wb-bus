...
s = re.sub(r'<strong data-count="\d+">\d+</strong> places', f'<strong data-count="{stops}">{stops:,}</strong> stops', s)
s = re.sub(r'<strong data-count="\d+">\d+</strong> routes', f'<strong data-count="{routes}">{routes:,}</strong> routes', s)
s = re.sub(r'<strong data-count="\d+">\d+</strong> bus services', f'<strong data-count="{buses}">{buses:,}</strong> bus services', s)
